...
namespace EditorWinEx.Internal
{
	...
	{
		public EWRectangle( float x, float y, float z, float w, bool anchorLeft, bool anchorRight, bool anchorTop, bool anchorBottom)
		{
		...
		public Rect GetRect( Rect rect)
		{
			...
			else
			{
				...
				if( anchorLeft != false && anchorRight != false)
				{
					result.x = rect.x + x;
					result.width = rect.width - x - z;
				}
				else if( anchorLeft != false)
				{
					result.x = rect.x + x;
					result.width = z;
				}
				else if( anchorRight != false)
				{
				...
				if( anchorTop != false && anchorBottom != false)
				{
					result.y = rect.y + y;
					result.height = rect.height - y - w;
				}
				else if( anchorTop != false)
				{
					result.y = rect.y + y;
					result.height = w;
				}
				else if( anchorBottom != false)
				{
