...
namespace EditorWinEx.Internal
{
    ...
    internal class SubWindowLayout
    {
        ...
        public XmlElement UseLayout(string layoutName, string treeId)
        {
            ...
            if (File.Exists(path))
            {
                ...
                if (nodes.Count == 1)
                {
                    ...
                    {
                        if (EditorUtility.DisplayDialog("Error", "The layout is malformed. Did you delete it?", "Yes", "No"))
                        {
        ...
        public void RevertLayout()
        {
            ...
            {
                if (EditorUtility.DisplayDialog("Remove all layouts", "Do you want to delete all layout files?", "Yes", "No"))
                {
